                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex flex-col gap-4 mb-5">
                                                ...
                                                {showCategoryDropdown && (
                                                    ...
                                                    >
                                                        {categories.map((cat) => (
                                                            ...
                                                            >
                                                                <span>{cat === "All" ? "All" : cat}</span>
                                                                <span className="text-xs bg-gray-100 text-gray-500 px-2.5 py-0.5 rounded-full font-bold">
                                                                    {getCategoryCount(cat)}
                                                                </span>
                                                            </button>
                                                        ))}
                                        ...
                                        <div className="flex items-center justify-between w-full mt-2 border-b border-gray-100 pb-3">
                                            <h3 className="text-lg md:text-xl font-bold text-gray-950 font-sans tracking-tight">Featured items</h3>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div className="space-y-1.5">
                                                                            <input
                                                                                ...
                                                                                className="w-full px-2.5 py-1.5 rounded-lg border border-gray-200 focus:outline-none focus:ring-1 focus:ring-[#F1641E] text-xs bg-gray-50"
                                                                            />
                                                                            <input
                                                                                type="number"
